...
// class CommentAddLoading extends CommentListState {}

// class CommentAddSuccess extends CommentListState {}

// class CommentAddError extends CommentListState {
//   final AppException exception;

//   const CommentAddError(this.exception);
//   @override
//   List<Object> get props => [exception];
// }
