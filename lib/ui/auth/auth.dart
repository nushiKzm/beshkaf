...
class _AuthScreenState extends State<AuthScreen> {
  final TextEditingController usernameController =
      TextEditingController(text: "MaryamHeidari@gmail.com");
    ...
    return Theme(
      data: themeData.copyWith(
          ...
          snackBarTheme: SnackBarThemeData(
            ...
            // contentTextStyle: TextStyle(fontFamily: '')
          ),
      ...
      child: Scaffold(
        ...
        body: BlocProvider<AuthBloc>(
          create: (context) {
            ...
            //هر ایونتی که میاد فانکشن داخل فورایچ براش صدا زده میشه
            //به استیت مثل ایونت رفتار میکنه
              ...
              builder: (context, state) {
                return Column(
                  ...
                  children: [
                    ...
                    Text(
                      state.isLoginMode ? 'بشکاف' : 'ثبت نام',
